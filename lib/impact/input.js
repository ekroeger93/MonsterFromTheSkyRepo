...
ig.Input = ig.Class.extend({
	...
	mousemove: function( event ) {		
		...
		var internalHeight = parseInt(ig.system.canvas.offsetHeight) || ig.system.realHeight;//added
        
		var scale = ig.system.scale * (internalWidth / ig.system.realWidth);
        
		var scaleY = ig.system.scale * (internalHeight / ig.system.realHeight);//added
		...
		this.mouse.y = (ev.clientY - pos.top) / scaleY;//added
	},
